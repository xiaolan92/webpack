...
;(function () {
  ...
  var u = [
    h,
    'auto,case,char,const,default,double,enum,extern,float,goto,int,long,register,short,signed,sizeof,assets,struct,switch,typedef,union,unsigned,void,volatile'
  ]
  var p = [
    u,
